...
return(
    ...
    <div className="bg-success p-2 text-white bg-opacity-75">Add your Skill details</div>

    <form className="was-validated" autoComplete="off" onSubmit={formik.handleSubmit}>
         <br></br>
          <label id="skill">Name :</label>
          <input name="name" type="text" className="form-control" id="validationTextarea" value={formik.values.name} onChange={formik.handleChange} required placeholder="Enter the Skill name" />
          {formik.errors.name ? <div>{formik.errors.name}</div> : null}
          <br>
          </br>
            <label  id="skill">Description :</label>
            <input name="description" type="text" className="form-control" id="validationTextarea"  value={formik.values.description} onChange={formik.handleChange} required placeholder="Enter the description"  />
