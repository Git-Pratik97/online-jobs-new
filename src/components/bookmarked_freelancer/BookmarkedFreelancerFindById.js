...
const BookmarkedFreelancerFindById = () => {
  ...
  const loadfreelancer = async () => {
    const result = await axios.get(`http://localhost:8080/jobportal/bookmarkedfreelancer/findbyid/${freelancer}`);
  ...
  return (
    ...
    <div>
      ...
      <ul className="nav nav-tabs">
        ...
        <li className="nav-item">
          <a className="nav-link active" href="/bookmarked_freelancer/findbyid">
            Find By ID
          </a>
        </li>
        <li className="nav-item">
